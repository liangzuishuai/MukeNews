	...
	<view>
		...
		<view class="my-content">
			<view class="my-content__list" @click="open">
				...
				<uni-icons type="arrowright" size="14" color="#666" @click="open"></uni-icons>
			</view>
			<view class="my-content__list" @click="openFeedback">
				...
				<uni-icons type="arrowright" size="14" color="#666" @click="openFeedback"></uni-icons>
			</view>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		data() {
			return {
				image: '/static/58f48ea81f0fe.jpg'
			}
		},
		computed: {
			...mapState(['userinfo'])
